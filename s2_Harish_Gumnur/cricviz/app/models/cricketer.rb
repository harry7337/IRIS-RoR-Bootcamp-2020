class Cricketer < ApplicationRecord
  ...
  def batting_average
    if (innings_batted - not_out) == 0
      return runs_scored
    elsif innings_batted==nil || not_out==nil || runs_scored==nil
      return nil
    else
  ...
  def batting_strike_rate
    if balls_faced==0
      return nil
    elsif balls_faced==nil
      return nil
    elsif runs_scored==nil
      return nil
    else
       return (runs_scored.to_f*100.0)/balls_faced.to_f
    end
  end
  ...
  def self.import_classical_batters
    ...
    Cricketer.create(name:'Kumar Sangakkara', country:'Sri Lanka', role:'Wicketkeeper', matches:'134', innings_batted:'233',not_out:'17',runs_scored:'12400',balls_faced:'22822',high_score:'319',centuries:'38',half_centuries:'52')
